...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const i18nData = {
    ja: {
      ...
      statEngines: "OS標準多言語TTS (日本語/英語/他)",
      statPriceVal: "¥980",
      ...
      feat4Title: 'OS標準の高速音声エンジン<br>(日本語・英語・多言語対応)',
      feat4Text: 'WindowsやmacOSに標準搭載されている自然で流暢な音声エンジン（日本語・英語・世界中の言語）をフル活用。事前の巨大モデルダウンロードや待機時間が一切なく、テキストを入力した瞬間に0秒で発話を開始します。',
      feat4Tag: '#即時発話ゼロ遅延 #多言語OS対応',
      ...
      uc3Desc: "OS内蔵のクリアなネイティブ発音（英語・日本語等）と母音に連動した口元の動きを同時に確認。視覚と聴覚を組み合わせた効果的なリスニング教材を作成可能。",
      uc3Tag: "クリアな発音＋視覚口パク",
      ...
      step2Desc: "喋らせたい文章を入力し、好みの音声（日本語 / 英語など）と読み上げ速度を選択。背景色もグリーンバックや透明に設定できます。",
      ...
      pf3: "OS標準 多言語音声合成（日本語・英語など）＆ 0秒即時発話",
      ...
      faq3A: "はい、完全に対応しています。Windows（Haruka, Ichiro, Ayumi等）やmacOS（Kyoko, Otoya, Siri等）に標準搭載されている高品位な日本語音声エンジンを直接利用し、滑らかで自然なイントネーションで流暢に読み上げます。",
    ...
    en: {
      ...
      heroTag3: "OS Native Fast TTS & Instant Speech",
      ...
      statEngines: "Native Multilingual TTS",
      statPriceVal: "¥980",
      ...
      feat4Title: 'Native OS Speech Engine<br>(Instant Multilingual TTS)',
      feat4Text: 'Leverages high-speed native speech synthesizers in Windows and macOS. Zero model downloads and zero startup wait time—speak instantly in Japanese, English, and dozens of global languages.',
      feat4Tag: '#ZeroWaitSpeech #Multilingual',
      ...
      uc3Desc: "Study natural native pronunciation (English, Japanese, etc.) and vowel mouth movements in sync. Perfect audio-visual learning synergy.",
      uc3Tag: "Clear Audio & Lip Shapes",
      ...
      step2Desc: "Type or paste your script, select your preferred system voice (Japanese / English, etc.) and speed. Choose green screen or transparent background.",
      ...
      pf3: "Native OS Multilingual Speech & Instant 0s Playback",
      ...
      faq3A: "Yes! The desktop app directly utilizes your operating system's native speech synthesizers (e.g., Haruka/Ichiro on Windows, Kyoko/Otoya on macOS) as well as dozens of worldwide languages with instant, zero-latency playback.",
